...
export const RegistroArena = ({ className }: { className?: string }) => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    const metodoPagamentoAceito =
      metodoPagamento === "ARENAHUB" || metodoPagamento === "AMBOS"
        ? metodoPagamento
        : null;
    ...
    const payload: ArenaCreate = {
      ...
      tipoChavePix:
        metodoPagamento === "ARENAHUB" || metodoPagamentoAceito === "AMBOS"
          ? tipoChavePix
          : null,
      ...
      {(metodoPagamento === "ARENAHUB" || metodoPagamento === "AMBOS") && (
        <Flex vertical className="md:!flex-row" gap="middle">
          ...
          >
            ...
            {!tipoChavePix && (
              <Input placeholder="Selecione o tipo de chave acima" disabled />
            )}
          </Form.Item>
        </Flex>
      )}
